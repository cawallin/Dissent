...
#include "Anonymity/EmptyRound.hpp"

namespace Dissent {
using namespace Anonymity::Nonce;
namespace Tests {
  TEST(NonceGeneration, Basic)
  {
    SessionCreator callback = SessionCreator(TCreateNonceRound<NonceRound, 
        NullRound>);
